# Archived known-answer files of profile v0.1.4

These files belong to profile v0.1.4 and its implementation, removed when
profile v0.2 replaced it ([`docs/specs.md`](../../../docs/specs.md), section 18).
They are kept for the record: the tools and tests that produced or checked
them no longer exist, and nothing in the repository reads them. The archived
specification is [`docs/legacy/v0.1.4/specs.md`](../../../docs/legacy/v0.1.4/specs.md).

The rest of this file is the README of that era, unchanged.
