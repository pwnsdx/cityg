...
- Useful future work is now optional scale-up on top of the named runners above:
  ...
  - turning the mutation suite into a true fuzz/property harness once the
    deterministic byte-flip sweep stops finding bugs
