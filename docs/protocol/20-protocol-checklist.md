...
- Useful future work is now optional scale-up:
  - longer 8-16 member chaos/soak runs
  - automated mutation fuzzing over valid baseline bundles
  - broader concurrent restart campaigns on top of the existing covered flows
