#!/usr/bin/env bash
# Run every scenario of the archived City-G v0.2 symbolic model and compare ProVerif's
# verdicts with the expected ones, query by query.
# Usage: docs/legacy/v0.2/formal/run.sh [path/to/proverif]    (default: proverif in PATH)
set -euo pipefail
