...
```bash
docs/legacy/v0.2/formal/run.sh                 # ProVerif in PATH
docs/legacy/v0.2/formal/run.sh /path/to/proverif
```
...
* **Not modelled.** Invite-based admissions (kind 1) and invite expiry;
  ...
  [conformance manifest](../../../../kat/legacy/v0.2/kat-v0.2-conformance-manifest.json).
