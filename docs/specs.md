...
| --- | --- |
| Profile | `city-g/v0.2` |
| Status | Normative. Supersedes profile v0.1.4 ([archived](legacy/v0.1.4/specs.md)); the two profiles do not interoperate. |
...
| Conformance | [`kat/v0.2/vectors.json`](../kat/v0.2/vectors.json), checked by the reference implementation and by the independent verifier [`kat/v0.2/verify_vectors.py`](../kat/v0.2/verify_vectors.py); requirement map [`kat/kat-v0.2-conformance-manifest.json`](../kat/kat-v0.2-conformance-manifest.json) |
...
* [`kat/v0.2/vectors.json`](../kat/v0.2/vectors.json) holds vectors for
...
* [`kat/v0.2/verify_vectors.py`](../kat/v0.2/verify_vectors.py) recomputes
