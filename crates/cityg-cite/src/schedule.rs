...
use cityg_core::error::CoreResult;
use cityg_core::hash::{Digest, ZERO32, extract, h};
use cityg_core::kem::{KemSecret, encapsulate};
use rand_core::CryptoRngCore;
use zeroize::{Zeroize, ZeroizeOnDrop};

use crate::crypto::{PROFILE, Secret, derive_secret, expand_label32, h_l, mac};
...
mod tests {
    ...
    fn the_context_binds_every_field() {
        ...
        let v03 = cityg_core::key_schedule::GroupContext {
            gid: base.gid,
            epoch: base.epoch,
            tree_hash: base.tree_hash,
            registry_hash: base.registry_hash,
            confirmed_transcript_hash: base.confirmed_transcript_hash,
        };
        assert_ne!(v03.hash().unwrap(), hash);
    }
