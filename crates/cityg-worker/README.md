...
- the remaining realtime gap is no longer basic routing or client semantics, but operational tuning: replay-window sizing, disconnect thresholds, and whether the current `sync_required` policy is sufficient under real Worker traffic
