...
- `/v2/barrier/resolve_revoked_occupancies`, `/v2/barrier/resolve_join_occupancies_since`, `/v1/barrier/fetch_public_tree`, and `/v1/barrier/lookup_merge_acceptance` can now execute inside the room Durable Object by rehydrating `RuntimeRoom` and reusing the shared runtime barrier-helper preparation logic
