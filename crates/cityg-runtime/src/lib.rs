...
pub use service::{
    ...
    PreparedResolvedJoinOccupancies, PreparedResolvedJoins,
    PreparedResolvedRevokedLeaves, PreparedResolvedRevokedOccupancies,
    RoomAcceptEpochError, RoomAuthorizationError, RoomBarrierEnvelopeError,
    ...
    prepare_resolved_joins, prepare_resolved_revoked_leaves,
    prepare_resolved_revoked_occupancies, refresh_room_pivot, revoke_room_admin,
    rotate_room_kbroad, seed_room_window_head, snapshot_room_telemetry,
    snapshot_room_window, store_room_message,
};
pub use storage::{
