...
pub use service::{
    ...
    PreparedResolvedJoinOccupancies, PreparedResolvedRevokedOccupancies, RoomAcceptEpochError,
    RoomAuthorizationError, RoomBarrierEnvelopeError, RoomBarrierHelperPreparationError,
    RoomBundleMaterializationError, RoomFullVerificationWitnessPreparationError,
    ...
    apply_bundle_indexes, apply_room_window_limit_update, bootstrap_room_with_admin,
    classify_refresh_pivot_conflict, commit_prepared_accepted_bundle, encode_pivot_parity_cbor,
    ensure_leaf_member_for_epoch, ensure_leaf_member_for_room, fetch_room_bundle,
