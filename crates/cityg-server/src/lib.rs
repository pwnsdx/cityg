...
mod tests {
    use super::{
        ...
        collect_expected_pairs, compute_barrier_tree_hash, compute_group_barrier_tree_hash,
        compute_revocation_roots_hash, cover_leaf_index, global_history_parent_attestation_id,
        parse_barrier_update, parse_global_history_attestation,
